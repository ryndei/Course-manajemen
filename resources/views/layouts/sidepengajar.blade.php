<div class="wrapper">
   ...
   with font-awesome or any other icon font library -->
                    <li class="nav-item">
                        <a href="{{ '/pengajar/pengajarhome' }}"
                            class="nav-link {{ request()->is('pengajar/pengajarhome') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ '/pengajar/jadwal' }}"
                            class="nav-link {{ request()->is('pengajar/jadwal') ? 'active' : '' }}">
                            <i class="fa-solid fa-house"></i>
                            <p>
                                Jadwal
                            </p>
